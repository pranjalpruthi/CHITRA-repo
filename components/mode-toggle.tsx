...
export default function ModeToggle({ iconOnly = false }: { iconOnly?: boolean }) {
    ...
    return (
        <button
            ...
            type="button"
        >
            <span className={cn("relative size-6 scale-75 rounded-full bg-gradient-to-tr")}>
                <span
                    className={cn(
            ...
            {!iconOnly && (
                <span className="relative h-6 w-12 overflow-hidden">
                    <span
                        className={cn(
