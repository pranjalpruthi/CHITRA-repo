...
function AuthenticatedNav() {
    const auth = useAuth();
    return <NavBarContent userId={auth.userId} />;
}

// Create the main content component that receives userId as a prop
                ...
                <Dialog>
                    ...
                    <SheetContent side="left">
                        ...
                        <div className="flex flex-col space-y-3 mt-[1rem]">
                            ...
                            <DialogClose asChild>
                                <Link href="/chromoviz" legacyBehavior passHref className="cursor-pointer">
                                    <Button variant="outline">
                                        ChromoViz
                                    </Button>
                                </Link>
                            ...
                            <DialogClose asChild>
                                <Link href="/c2" legacyBehavior passHref className="cursor-pointer">
                                    <Button variant="outline">
                                        C2
                                    </Button>
                                </Link>
