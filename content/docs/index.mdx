...
1. **Basic Synteny**  
   - _Visualize synteny blocks among_
   - Input files required

   _Visualize synteny blocks among_
2. _Visualize synteny blocks among_ **three species**.  
...
- reference_chromosome_sizes.csv2. **Multiple Synteny**  

    _Compare synteny blocks among_ \*multiple species\*\*  

    _Input files required same as_ \*Basic Synteny\*\*  

     \* ref\\\_gene\\\_annotations.csv  

     \* breakpoints.csv  

3\. **Annotated Genome**  

    _Analyze_ \*annotated genomes\*\* using real datasets.  
